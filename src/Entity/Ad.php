...
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre ne doit pas faire moins de 10 caractère",
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre description ne doit pas faire moins de 100 caractères")
     */
    private $content;
